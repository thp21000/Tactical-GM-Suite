...
export function SettingsDebugSection({ obr, moduleStates, theme }: SettingsDebugSectionProps) {
  ...
  const summaryRows = [
    ...
    ["OBR primary.main", theme.obr?.primaryMain ?? "non disponible"],
    ["OBR secondary.main", theme.obr?.secondaryMain ?? "non disponible"],
    ["OBR text.primary", theme.obr?.textPrimary ?? "non disponible"],
    ["OBR text.secondary", theme.obr?.textSecondary ?? "non disponible"],
    ["OBR divider", theme.obr?.divider ?? "non disponible"],
