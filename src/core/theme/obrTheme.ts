...
export const fallbackTgmTheme: TgmTheme = {
  ...
  accent: "#c084fc",
  variables: {
    "--tgm-bg": "rgba(15, 17, 23, 0.72)",
    "--tgm-bg-soft": "rgba(20, 24, 33, 0.58)",
    "--tgm-surface": "rgba(24, 28, 38, 0.70)",
    "--tgm-surface-strong": "rgba(31, 36, 49, 0.86)",
    "--tgm-surface-glass": "rgba(24, 28, 38, 0.52)",
    "--tgm-border": "rgba(255, 255, 255, 0.12)",
    "--tgm-border-strong": "rgba(255, 255, 255, 0.20)",
    "--tgm-text": "#f3f4f6",
...
export function createTgmThemeFromObrTheme(theme: ObrTheme): TgmTheme {
  ...
  return {
    ...
    variables: {
      ...
      "--tgm-bg": deriveGlassSurface(defaultBackground, isLight ? 0.78 : 0.72),
      "--tgm-bg-soft": deriveGlassSurface(defaultBackground, isLight ? 0.58 : 0.58),
      "--tgm-surface": deriveGlassSurface(paperBackground, isLight ? 0.74 : 0.70),
      "--tgm-surface-strong": deriveGlassSurface(paperBackground, isLight ? 0.88 : 0.86),
      "--tgm-surface-glass": deriveGlassSurface(paperBackground, isLight ? 0.56 : 0.52),
